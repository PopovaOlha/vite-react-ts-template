(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [888],
  {
    ...
    7563: function (e, t, r) {
      ...
      let l = (0, o.xC)({
        reducer: {
          search: a.ZP,
          selected: s.ZP,
          [u.Ue.reducerPath]: u.Ue.reducer,
        },
        middleware: (e) => e().concat(u.Ue.middleware),
      });
      (0, c.sj)(l.dispatch), r(6119);
      var f = r(8114),
        d = function (e) {
          let { Component: t, pageProps: r } = e;
          return (0, n.jsx)(i.zt, {
            store: l,
            children: (0, n.jsx)(f.f, { children: (0, n.jsx)(t, { ...r }) }),
          });
        };
    },
    3927: function (e, t, r) {
      ...
      var m = !!(
        ...
        v = m || g ? u.useLayoutEffect : u.useEffect,
        b = (e) =>
          e.isUninitialized
            ? {
                ...e,
      ...
      let _ = (0, n.Tk)(
          ...
          (({
            ...
            createSelector: r = s.P1,
            unstable__sideEffectsInRender: i = !1,
            ...f
          } = {}) => ({
            name: w,
            init(s, { serializeQueryArgs: f }, m) {
              let {
                buildQueryHooks: g,
                buildMutationHook: w,
                usePrefetch: _,
                ...
                moduleOptions: {
                  batch: t,
                  hooks: { useDispatch: r, useSelector: i, useStore: s },
                ...
                return {
                  buildQueryHooks: function (c) {
                    let _ = (
                        ...
                        let _ = h(l ? n.CN : t, d, m.endpointDefinitions[c], c),
                          S = y({
                            refetchOnReconnect: i,
                            refetchOnFocus: a,
                            pollingInterval: f,
                          ...
                          P = !1;
                        E && R && (P = w.current.isRequestSubscribed(E, R));
                        let A = !P && O.current;
                        return (
                          g(() => {
                            O.current = P;
                          ...
                          (0, u.useMemo)(
                            () => ({
                              refetch: () => {
                                if (!j.current) throw Error((0, o.rJ)(38));
                      ...
                      S = ({
                        ...
                        g(() => {
                          m !== h.current?.subscriptionOptions &&
                            h.current?.updateSubscriptionOptions(m);
                        }, [m]);
                        let v = (0, u.useRef)(m);
                        g(() => {
                          v.current = m;
                      ...
                      O = (t, { skip: r = !1, selectFromResult: o } = {}) => {
                        let { select: d } = e.endpoints[c],
                          p = h(r ? n.CN : t, f, m.endpointDefinitions[c], c),
                          y = (0, u.useRef)(void 0),
                          g = (0, u.useMemo)(
                            () =>
                              l([d(p), (e, t) => t, (e) => p], w, {
                          ...
                          _ = i((e) => b(e, y.current), a.wU),
                          S = g(s().getState(), y.current);
                        return (
                          v(() => {
                            y.current = S;
                          }, [S]),
                  ...
                  buildMutationHook: function (n) {
                    return ({ selectFromResult: o, fixedCacheKey: s } = {}) => {
                      ...
                      let y = (0, u.useCallback)(
                        ...
                        g = (0, u.useMemo)(
                          () =>
                            c({ fixedCacheKey: s, requestId: p?.requestId }),
                          [s, p, c],
                        ),
                        v = i(
                          (0, u.useMemo)(() => (o ? l([g], o) : g), [o, g]),
                          a.wU,
                        ),
                        b = null == s ? p?.arg.originalArgs : void 0,
                        w = (0, u.useCallback)(() => {
                          t(() => {
                            p && h(void 0),
                              s &&
                  ...
                  injectEndpoint(e, t) {
                    if ('query' === t.type) {
                      ...
                      c(s.endpoints[e], {
                        ...
                        (s[`use${l(e)}Query`] = t),
                        (s[`useLazy${l(e)}Query`] = r);
                    } else if ('mutation' === t.type) {
                      let t = w(e);
                      c(s.endpoints[e], { useMutation: t }),
                        (s[`use${l(e)}Mutation`] = t);
                    }
                  },
                }
              );
          ...
          baseQuery: (0, n.ni)({ baseUrl: 'https://swapi.dev/api/' }),
          endpoints: (e) => ({
            searchCharacters: e.query({
              query: (e) => {
                let { searchTerm: t, page: r } = e;
                return t
                  ? 'people/?search='.concat(t, '&page=').concat(r)
                  : 'people/?page='.concat(r);
              },
              transformResponse: (e) =>
                e.results.map((e) => {
        ...
        { useSearchCharactersQuery: S, useGetCharacterDetailsQuery: O } = _;
    },
    4468: function (e, t, r) {
      'use strict';
      r.d(t, {
      ...
      let n = (0, r(5060).oM)({
          ...
          reducers: {
            toggleSelectItem: (e, t) => {
              let r = e.selectedItems.findIndex((e) => e.id === t.payload.id);
              r >= 0
        ...
        { toggleSelectItem: i, setSelectedItems: o } = n.actions;
      t.ZP = n.reducer;
    },
    6119: function () {},
    7663: function (e) {
    ...
    7426: function (e, t, r) {
        ...
        return (
          ...
          async (p, y) => {
            ...
            let {
              ...
              {
                url: P,
                headers: A = new Headers(g.headers),
                params: T,
                responseHandler: C = f ?? 'json',
                validateStatus: x = d ?? h,
                timeout: q = s,
                ...M
            ...
            if (
              ...
              let e = ~P.indexOf('?') ? '&' : '?';
              P += e + (n ? n(T) : new URLSearchParams(m(T)));
            }
            let D = new Request(
              (P = (function (e, t) {
                var r;
            ...
            return x(I, w)
              ? { data: w, meta: b }
              : { error: { status: I.status, data: w }, meta: b };
          }
        );
      ...
      function j(e, t) {
        return t
          ? t(e, { onFocus: b, onFocusLost: w, onOffline: S, onOnline: _ })
          : (function () {
              let t = () => e(b()),
                r = () => e(w()),
                n = () => e(_()),
      ...
      var C = Symbol('forceQueryFn'),
        x = (e) => 'function' == typeof e[C];
      function q(e) {
        return e;
      }
      function M(e, t, r, n) {
      ...
      var I = {},
        ...
        Q = (0, u.Uy)($, () => {}),
        U = (0, u.Uy)($, () => {}),
        L = WeakMap ? new WeakMap() : void 0,
        K = ({ endpointName: e, queryArgs: t }) => {
          let r = '',
            n = L?.get(t);
          if ('string' == typeof n) r = n;
          else {
            ...
            n = {
              ...
              serializeQueryArgs(e) {
                ...
                if ('serializeQueryArgs' in e.endpointDefinition) {
                  ...
                  r = (e) => {
                    let r = t(e);
                    return 'string' == typeof r ? r : K({ ...e, queryArgs: r });
                  };
      ...
      var W = ({
        ...
        J = ({
          ...
          return (e, t) => {
            b.match(e) && u(t, 'refetchOnFocus'),
              _.match(e) && u(t, 'refetchOnReconnect');
          };
        },
        H = Error('Promise never resolved before cacheEntryRemoved.'),
        X = ({
          api: e,
          reducerPath: t,
          context: r,
      ...
      var et = Symbol(),
        er = ({ createSelector: e = a.P1 } = {}) => ({
          ...
          init(
                ...
                middleware: (r) => {
                  ...
                  return (e) => (s) => {
                    ...
                    if (
                      ((l = m ? e(s) : g),
                      r.getState()[t] &&
                        (h(s, f, y), c(s) || u.hasRehydrationInfo(s)))
                    )
            ...
            ee(t.util, eo), ee(t, { reducer: er, middleware: ei });
            let {
              ...
              return {
                buildQuerySelector: function (i, u) {
                  return (a) => {
                    ...
                    return r(a === z ? n : (e) => e[t]?.queries?.[s] ?? Q, o);
                  };
                },
            ...
            let {
              ...
              return {
                      ...
                      let g = e({
                        ...
                        P = Object.assign(
                              ...
                              : Promise.all([E, w]).then(R),
                          {
                            ...
                            refetch: () =>
                              y(u(s, { subscribe: !1, forceRefetch: !0 })),
                            unsubscribe() {
                              l && y(a({ queryCacheKey: g, requestId: S }));
                            },
                            updateSubscriptionOptions(e) {
                              (P.subscriptionOptions = e),
                                y(
                                  c({
                                    endpointName: r,
                                    requestId: S,
                  ...
                  return (t, { track: n = !0, fixedCacheKey: i } = {}) =>
                    (o, a) => {
                      ...
                      return (
                        ...
                        (m[d] = y),
                        y.then(() => {
                          delete m[d], T(m) || u.delete(o);
                        }),
                        i &&
                          ((m[i] = y),
                          y.then(() => {
                            m[i] !== y || (delete m[i], T(m) || u.delete(o));
                          })),
                        y
                      );
                    };
                ...
                getRunningQueriesThunk: function () {
                  return (e) => Object.values(o.get(e) || {}).filter(A);
                },
                getRunningMutationsThunk: function () {
                  return (e) => Object.values(u.get(e) || {}).filter(A);
                },
              };
            })({
              queryThunk: O,
    ...
    5060: function (e, t, r) {
      ...
      r.d(t, {
        ...
        Gx: function () {
          return function e(...t) {
            return 0 === t.length
              ? (e) => A(e, ['pending', 'fulfilled', 'rejected'])
              : T(t)
                ? R(...t.flatMap((e) => [e.pending, e.rejected, e.fulfilled]))
                : e()(t[0]);
          };
        },
        KD: function () {
      ...
      var y = () =>
        ...
        _ = (e) =>
          function (t) {
            let { autoBatch: r = !0 } = t ?? {},
              n = new d(e);
            return r && n.push(w('object' == typeof r ? r : void 0)), n;
          };
      function S(e) {
        let t, r;
        let n = y(),
      ...
      var j = (e = 21) => {
        ...
        E = (e, t) => (l(e) ? e.match(t) : e(t));
      function R(...e) {
        return (t) => e.some((e) => E(e, t));
      }
      function P(...e) {
        return (t) => e.every((e) => E(e, t));
      }
      function A(e, t) {
      ...
      function C(...e) {
        return 0 === e.length
          ? (e) => A(e, ['rejected'])
          : T(e)
            ? R(...e.map((e) => e.rejected))
            : C()(e[0]);
      }
      var x = ['name', 'message', 'stack', 'code'],
        q = class {
          constructor(e, t) {
        ...
        N = (e) => {
          if ('object' == typeof e && null !== e) {
            let t = {};
            for (let r of x) 'string' == typeof e[r] && (t[r] = e[r]);
            return t;
          }
      ...
      var U = (e, t) => {
        ...
        V = Object.assign(f(`${K}/add`), { withTypes: () => V });
      f(`${K}/removeAll`);
      var B = Object.assign(f(`${K}/remove`), { withTypes: () => B });
      function J(e) {
    ...
    3513: function (e, t, r) {
      ...
      function y(e) {
        let t = e[u];
        return t ? t.type_ : Array.isArray(e) ? 1 : b(e) ? 2 : w(e) ? 3 : 0;
      }
      function m(e, t) {
        return 2 === y(e)
          ? e.has(t)
      ...
      var I = {
          ...
          deleteProperty: (e, t) => (
            void 0 !== $(e.base_, t) || t in e.base_
              ? ((e.assigned_[t] = !1), L(e), U(e))
